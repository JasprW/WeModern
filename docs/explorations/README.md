...
| [微信语音/视频通话通知实验与采集记录](2026-07-18-wechat-call-notification-capture.md) | 已实现 / 待真机验证 | 保留全部已撤回尝试；开发构建使用标准 CallStyle，Answer/Decline 都只打开微信通话页；接通由微信 `0x62` 候选门控音频模式快速确认，并保留通知更新与超时兜底。 |
